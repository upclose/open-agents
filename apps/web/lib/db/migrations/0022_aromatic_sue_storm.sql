...
ALTER TABLE "vercel_project_links" ADD CONSTRAINT "vercel_project_links_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "vercel_project_links_user_repo_idx" ON "vercel_project_links" USING btree ("user_id","repo_owner","repo_name");